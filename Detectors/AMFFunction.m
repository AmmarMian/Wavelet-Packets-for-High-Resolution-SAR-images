...
% MAT-files required: Tyler.m, SCM.m
%% Authors
...
%% ------------- BEGIN CODE --------------
function ratio = AMFFunction(Data, Estimation)
% AMFFunnction: Compute AMF detection Test
% Syntax:  ratio = AMFFunction(Data, Estimates)
% Inputs:
...
%    ratio - the test ratio
    ...
    p = Data.p;
    y = Data.y;
    ratio = abs(p' * iMx * y)^2 / (abs(p' * iMx * p));
